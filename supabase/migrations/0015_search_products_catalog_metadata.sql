-- Expose products.catalog_metadata through search_products.
--
-- listProducts() returns this projection verbatim as ProductSummary, so a
-- column absent here is a column the recommendation engine cannot see — it
-- reads an empty object and cannot tell that apart from a product that
...
as $$
  ...
  select jsonb_build_object(
      ...
      'catalogMetadata', p.catalog_metadata,
